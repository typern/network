    ...
    success: function(data) {
      ...
      if (data.error) {
        ...
        $('.dashboards').html(function() {
          var pagospendientes = Number(data.pointsGiven) - Number(data.pointsCollected)
          var str = '';
          str = str + '<h5>Pagos pendientes: ' + pagospendientes  + ' </h5><br>';
          str = str + '<h5>Saldo total: ' + data.pointsCollected + ' </h5>';
          return str;
        });
